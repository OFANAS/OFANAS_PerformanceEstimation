...
class OFAMobileNetV3ElasticKernel(MobileNetV3):
    ...
    def __init__(self, n_classes=1000, bn_param=(0.1, 1e-5), dropout_rate=0.1, base_stage_width=None,
        ...
        super(OFAMobileNetV3ElasticKernel, self).__init__(first_conv, blocks, final_expand_layer, feature_mix_layer, classifier)
    ...
    @staticmethod
    def name():
        return 'OFAMobileNetV3ElasticKernel'
    ...
    def config(self):
        return {
            'name': OFAMobileNetV3ElasticKernel.__name__,
    ...
    def sample_compound_subnet(self, elastic_kernel=True):
